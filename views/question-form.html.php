...
<form name="post" action="admin.php?page=watu_questions&amp;quiz=<?php echo $_GET['quiz']; ?>&amp;action=<?php echo (empty($question->ID) or @$action=='new') ? 'new':'edit'?>" method="post" id="post">
<div id="poststuff">
...
<div class="postbox" id="questionAnswers">
	...
	<div class="inside">	
		...
		<p style="border-bottom:1px dotted #ccc"><textarea name="answer[]" class="answer" rows="3" cols="50"><?php if($action == 'edit' or !empty($_GET['question'])) echo stripslashes(@$all_answers[$i-1]->answer); ?></textarea>
